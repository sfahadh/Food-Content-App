  ...
  componentDidMount() {
    fetch(
      `https://api.nal.usda.gov/ndb/nutrients/?format=json&api_key=${
        process.env.REACT_APP_USDA_DATABASE_API_KEY
      }&nutrients=205&nutrients=203&nutrients=208&nutrients=204`
    )
      ...
      <div>
        <nav>
          ...
          <ul>
            ...
            <li>
              <Link style={{ color: "orange" }} to="articles">
                Articles
              </Link>
            </li>
            <li>
              <Link style={{ color: "orange" }} to="food-tracker">
                Food Tracker
              </Link>
            </li>
            <li>
